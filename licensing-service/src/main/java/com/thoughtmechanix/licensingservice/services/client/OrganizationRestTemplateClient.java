...
import com.thoughtmechanix.licensingservice.repository.OrganizationRedisRepository;
...
public class OrganizationRestTemplateClient {
  ...
  public Organization getOrganization(String organizationId) {
    ...
    if (organization != null) {
      logger.debug("I have successfully retrieved an organization {} form the redis cache: {}", organizationId, organization);
      return organization;
    }
